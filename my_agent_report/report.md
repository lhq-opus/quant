...
The company invested substantial resources. One incident I recall involved an employee's multi-agent experiment using Claude Opus 4.6, which incurred RMB 2 million in token costs in one day. My understanding is that the gateway had no usage cap and the experiment had no limits on agent numbers or inter-agent message-history volume. The company ultimately treated the incident as a necessary cost of exploring LLMs. The figure, its accounting basis, experimental results, and subsequent controls still need supporting records.
...
This report combines my participation in miHoYo's data-team agent work and the December platform discussion with my broader observations and recollections. My comments on project scarcity concern the company as a whole, as I understood it at the time; they are not an exhaustive project inventory. The comparison focuses on LLM and agent adoption rather than the companies' overall AI capabilities.
...
The company invested substantial resources in this direction. During this period, the multi-agent experiment described in C05 incurred RMB 2 million in one day; the company ultimately classified it as a necessary cost of exploring LLMs. I am recounting the company's assessment here. My personal evaluation of that response remains to be developed in this draft.
...
**My understanding of the cause:** The company LLM gateway had no usage cap. The experiment also lacked limits on agent numbers and the volume of historical messages passed between agents. I associate the high consumption with these missing limits. The draft does not yet include logs or a breakdown of each factor's cost contribution.

**Company response:** The company ultimately regarded the incident as a necessary cost of exploring LLMs. The source of this characterization, prior budget authorization, and any subsequent changes to controls remain to be documented.

**Assessment pending:** The task attempted, technical result, learning obtained, and business value remain unspecified. The incident is therefore recorded as an experimentation cost case, without classifying the experiment's overall success or failure. The event and amount rest on my recollection. Anthropic's [Opus 4.6 release announcement](https://www.anthropic.com/news/claude-opus-4-6), dated February 5, 2026, provides model timeline context only.
...
I describe the following two to three months as a period of highly aggressive adoption and substantial spending. The views that general-purpose agent development was unnecessary and that the cost incident was a necessary exploration expense were company positions as I understood them. My own support, reservations, and later reflections on those positions still need to be developed.
...
**Experimentation and cost:** C05 combines a willingness to absorb a large exploration cost with missing usage limits. The value of an experiment and the way its consumption is bounded can be assessed separately. Accepting the expense does not establish what learning it produced or whether the same result was achievable at lower cost.
...
- **Experimental consumption — C05:** Set experiment budgets and gateway usage limits; cap agent numbers and the message history passed between them; pause or review runs at defined thresholds. Record spending, intended learning, and actual results together. Thresholds should reflect our resources and objectives.
...
- The date, task, result, learning, billing records, accounting basis, and cost breakdown for the RMB 2 million incident; who characterized it as a necessary cost; prior authorization and subsequent limits; my views at the time and in retrospect.
...
| U04 | My recollections of expansion after Echo and the multi-agent cost incident | Recorded September 17, 2026 | Following two to three months; at least four or five departmental OpenClaw adaptations; individual-task adoption and IM integration; company emphasis on frameworks and skills; substantial investment; RMB 2 million in one day using Opus 4.6, missing limits, and the company's response. Statement provenance, dates, billing evidence, workflow and experiment outcomes, and my personal evaluation of those company positions remain open. |
